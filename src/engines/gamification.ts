...
export const ACHIEVEMENTS_CONFIG: Array<{
  ...
  { id: 'first-step', title: 'First Step Champion', description: 'Log your first sustainability action', icon: '🏆', target: 1 },
  { id: 'eco-warrior', title: 'Eco Warrior', description: 'Complete 50 sustainability actions', icon: '⚔️', target: 50 },
  { id: 'plastic-free', title: 'Plastic-Free Week', description: '7 no-plastic actions logged', icon: '🚫', target: 7 },
  { id: 'carbon-zero', title: 'Carbon Zero Hero', description: 'Achieve EcoScore of 80+', icon: '🌍', target: 80 },
  { id: 'energy-guardian', title: 'Energy Guardian', description: 'Log 20 energy-saving actions', icon: '⚡', target: 20 },
  { id: 'planet-protector', title: 'Planet Protector', description: 'Earn 1000 ImpactTokens', icon: '🛡️', target: 1000 },
];
